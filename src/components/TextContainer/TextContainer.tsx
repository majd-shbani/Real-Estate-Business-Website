  ...
  return (
    <div
      className={`
        w-full
        p-4
        dark:bg-gray-10 bg-Platinum
        rounded-lg
        border
      dark:border-gray-15 border-Silver
    ...
    >
      ...
      <span className="text-Jet-Gray dark:text-gray-60 text-sm xl:text-[16px] 2xl:text-[18px] font-medium leading-[150%]">
        {Paragraph}
      </span>
    </div>
  );
