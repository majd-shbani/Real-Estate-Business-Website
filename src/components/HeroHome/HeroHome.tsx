...
const HeroHome = () => {
    return (
        <header className="bg-gray-08 my-10 xl:my-[98px] 2xl:my-36">
            <div className="pl-4 xl:pl-20 2xl:pl-[162px] flex flex-col-reverse xl:flex-row xl:flex-wrap xl:items-center xl:justify-between">
                <div className="max-w-[100vw] pr-4 xl:pr-0 xl:max-w-[37.9166vw]">
                    ...
                    <div className="">
                        <Button to="" className="w-full mb-4 text-white bg-gray-15 md:w-fit md:mr-4 md:mb-12.5 2xl:mr-5 2xl:mb-15" text="Learn More"></Button>
                        <Button to="" className="w-full mb-10 text-white bg-purple-60 md:w-fit md:mr-4 md:mb-12.5 2xl:mr-5 2xl:mb-15" text="Browse Properties"></Button>
                    </div>
                ...
                <div className="pr-4 xl:pr-0 mx-auto xl:mx-0 mb-22 xl:mb-0 flex flex-col-reverse relative max-w-[100vw] xl:max-w-[37.9166vw]">
                    ...
                    <div className=" border border-sloid border-gray-15 rounded-xl xl:rounded-none">
                        <img src="/Real-Estate-Business-Website/assets/images/herohome/heroImage.webp" alt="hero img"></img>
                    </div>
                </div>
