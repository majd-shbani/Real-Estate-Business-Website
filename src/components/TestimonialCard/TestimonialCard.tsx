...
const TestimonialCard = ({card}: TestimonialCardProps) => {
  return (
    <BaseCard className="flex flex-col justify-between h-full mx-auto xl:mx-0 max-w-112.5 md:max-w-full">
        <div>
          <StarRating icon={StarIcon.icon} rating={card.rating}/>
          <div className="flex flex-col gap-1.5 xl:gap-2.5 2xl:gap-3.5 mb-6 xl:mb-7.5 2xl:mb-10">
        ...
        <div className="flex items-center gap-2.5 2xl:gap-3">
          ...
          <div className="flex flex-col 2xl:gap-0.5">
            <p className="text-base xl:text-lg 2xl:text-xl font-medium leading-[150%]">{card.name}</p>
