...
const StartJourney = (journeyProps : StartJourneyProps) => {
  return (
      ...
      <div className="w-full px-4 md:px-[5.208333vw] xl:px-[5.55555vw] 2xl:px-[8.4375vw]  py-12.5 md:py-20  lg:py-15  2xl:py-25 relative  overflow-hidden  h-91.75 lg:h-64.75 2xl:h-91.75 border border-Silver dark:border-gray-15 leading-[150%]">
