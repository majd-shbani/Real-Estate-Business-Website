...
const StartJourney = (journeyProps : StartJourneyProps) => {
  return (
    <div>
      <div className="py-12.5 px-4 md: md:py-20  lg:py-15 md:px-20 2xl:py-25 relative  overflow-hidden  h-91.75 lg:h-64.75 2xl:h-[367px] border border-gray-15">
   

       <img className=" absolute  rotate-180 top-0 right-45 sm:right-60 sm:top-20 sm:rotate-0 lg:top-0  md:left-0 md:rotate-0 md:top-15 xl:-top-12  xl:left-0 xl:rotate-0 2xl:top-14 " src={journeyProps.journeyProps.leftImage}></img>
       ...
       <div className=" absolute  w-89.25 sm:w-[80%] md:w-[50%] lg:w-[65%] 2xl:px-40.5 2xl:w-[73%] ">
