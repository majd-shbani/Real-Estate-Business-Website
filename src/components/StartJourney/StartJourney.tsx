...
const StartJourney = (journeyProps : StartJourneyProps) => {
  return (
    <div>
      <div className="py-12.5 px-4 xl:py-15 relative    h-91.75 xl:h-64.75 border border-gray-15">
   

       <img className=" absolute  rotate-180 top-0 right-45 sm:right-90 md:top-15  md:left-0 md:rotate-0 xl:-top-13  xl:left-0 xl:rotate-0 " src={journeyProps.journeyProps.leftImage}></img>
