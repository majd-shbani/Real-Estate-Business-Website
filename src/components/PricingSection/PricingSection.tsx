    ...
    return (
        <Section title="Comprehensive Pricing Details"
                ...
                <div className="flex flex-col gap-7.5 xl:gap-10 2xl:gap-12.5">
                    <div className="flex justify-between items-center px-5 py-6 xl:py-5 xl:px-10 2xl:px-12.5 2xl:py-7.5 bg-Platinum dark:bg-gray-10  border border-Silver dark:border-gray-15 w-full rounded-xl">
                        <b className="text-lg xl:text-xl 2xl:text-2xl font-semibold pb-2.5 xl:pb-0 xl:pe-4 2xl:pe-5 ">Note</b>
                        <p className="text-sm 2xl:text-lg font-medium pt-2.5 xl:pt-0 xl:ps-4 2xl:ps-5 text-gray-60">The figures provided above are estimates and may vary depending on the property, location, and individual circumstances.</p>
                    </div>
