...
const StepsCard = ({items} : steps) => {
    return (
        ...
        {items.map((item , index) => {
            return (
                <div key={index} className="h-full max-w-100 lg:max-w-103.25 2xl:max-w-lg">
                    ...
                    <BaseCard className="relative h-[80%] rounded-tl-none flex flex-col gap-3.5 lg:gap-4 2xl:gap-5 bg-[linear-gradient(130.79deg,#703BF7_-49.01%,rgba(112,59,247,0)_13.65%)]">
                        <div className="absolute -top-px -left-px border-purple-60 border-l border-t w-1/4 h-26 opacity-40"></div>
