...
const Achievement = ({id ,title , description}: Achievement) => {
  ...
  return (
    <div key={id}  className=" justify-center border border-gray-15  shadow-thin-grey  xl:shadow-medium-grey 2xl:shadow-thick-grey rounded-xl h-42.25 sm:w-full p-7.5 md:h-35 lg:w-87.5 lg:h-53 xl:p-10 xl:w-[28.2vw]  2xl:p-[2.605vw] 2xl:w-[505.6px]  2xl:h-64 ">
      <div>
