...
const Achievement = ({id ,title , description}: Achievement) => {
  ...
  return (
    <div key={id}  className=" justify-center border border-gray-15  shadow-thin-grey  xl:shadow-medium-grey 2xl:shadow-thick-grey rounded-xl p-7.5 md:w-60 md:h-65 lg:w-87.5 lg:h-53 xl:p-10 xl:w-101.5  2xl:p-[2.605vw] 2xl:w-[505.6px]  2xl:h-64 ">
      <div>
