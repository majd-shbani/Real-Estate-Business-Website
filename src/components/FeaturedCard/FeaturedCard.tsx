...
const FeaturedCard = ({ id, image, alt, title, description, details, price }: FeaturedCardProps) => {
      ...
      return (
            <div  className="p-10">
                  ...
                  <div>
                        <h3>{title}</h3>
                        <p className="text-[14px] font-medium text-[#999999] leading-[150%] xl:text-[16px] 2xl:text-[18px]">
                        ...
                        <div className="flex items-center flex-wrap gap-1.5 2xl:gap-2.5 py-5 xl:py-6 2xl:py-7.5">
                              {details.map((item, index) => (
                                    <div key={index} className="flex items-center gap-1 px-3.5 py-2 border border-[#262626] bg-[#1A1A1A] rounded-3xl">
                        ...
                        <div className="flex justify-between items-center gap-7.5">
                              <div>
                                    <p className="text-[14px] 2xl:text-[18px] font-medium text-[#999999]">Pric:</p>
                                    <p className="text-[18px] xl:text-[20px] 2xl:text-[24px] font-semibold">{price}</p>
                              </div>
                              <Button
                                    text="View Property Details" to={`/propertyDetails/${id}`}
                                    className="bg-[#703BF7] border-none! text-white px-8.75! xl:px-[47.6px] 2xl:px-[54.5px]!">
                              </Button>
                        </div>
                  </div>
