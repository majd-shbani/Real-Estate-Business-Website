...
const FeaturedCard = ({ id, image, alt, title, description, details, price, categoryBadge }: FeaturedCardProps) => {
      ...
      return (
            <BaseCard className="p-6! xl:p-7.5! 2xl:p-10! self-start mx-auto xl:mx-0 max-w-112.5 md:max-w-full ">
                  ...
                  {categoryBadge && (
                        <div className="px-3 py-2 text-[14px] 2xl:text-[18px] font-medium border border-Silver dark:border-gray-15 rounded-[28px] w-fit bg-Platinum dark:bg-gray-10 mb-4 xl:mb-5">
                              {categoryBadge}
                        </div>
                  )}
                  ...
                  <div className="flex flex-col grow">
                        ...
                        <div className={`flex justify-between items-center gap-[1vw] pt-5 xl:pt-6 2xl:pt-7.5 }`}>
                              ...
                              <Button text="View Property Details" to={`/Properties/propertyDetails/${id}`} className=" text-white text-[clamp(12px,0.824vw,18px)]! dark:bg-purple-60 dark:border-0 dark:text-white px-[2.24vw]! xl:px-[3.3104vw]! 2xl:px-[2.73vw]! border border-Royal-Indigo! bg-Indigo " />
                        </div>
                  </div>
            </BaseCard>
      );
