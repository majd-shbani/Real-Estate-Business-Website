...
const DashboardEmployeeCard = ({card, onEdit, onDelete}: EmployeeCardProps) => {
  return (
    <BaseCard className="p-4! xl:p-6! flex flex-col w-full max-w-100 md:max-w-full mx-auto md:mx-0 relative group bg-Platinum border-Silver dark:bg-gray-15 dark:border-gray-60 transition duration-300 ease-in-out hover:border-2 hover:scale-105">
        <div className="flex flex-col items-center h-full">
            ...
            <h3 className="text-lg xl:text-xl font-bold text-Jet-Gray dark:text-white xl:mb-2">{card.name}</h3>
