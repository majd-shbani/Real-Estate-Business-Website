  ...
  return (
    <BaseCard className="p-5! md:p-7! xl:p-6! 2xl:p-7.5! flex flex-col w-full max-w-112.5 md:max-w-full mx-auto md:mx-0">
        <div className="relative mb-10 xl:mb-12.5 flex justify-center items-center">
            ...
            <div className="absolute -bottom-4.5 2xl:-bottom-6.5 rounded-[43px] px-[clamp(1.25rem,1.25vw+0.125rem,1.625rem)] py-[clamp(0.625rem,0.833vw-0.125rem,0.875rem)] bg-Indigo dark:bg-purple-60 flex justify-center items-center">
        ...
        <div className="flex items-center justify-between p-2 pl-6 xl:p-2.5 xl:pl-5 2xl:p-3.5 2xl:pl-6 border border-Silver dark:border-gray-15 rounded-full bg-Platinum dark:bg-gray-10">
            <input type="text" id={`employee-message-${card.id}`} name="employee message" placeholder={EMPLOYEE_CARD_DEFAULTS.placeholder} className="w-30 xl:max-w-37.5 bg-transparent text-sm xl:text-base 2xl:text-lg outline-none placeholder:text-Jet-Gray dark:placeholder:text-white placeholder:text-sm placeholder:xl:text-base placeholder:2xl:text-lg placeholder:font-medium placeholder:leading-7"/>
            <button type="submit" className="p-3.5 xl:p-2 2xl:p-2.5 bg-Indigo dark:bg-purple-60 rounded-full">
