    ...
    return (
        <>
            {items.map((item , index) => {
                ...
                return(
                    <div key={index} className="w-full border border-Silver dark:border-gray-15 rounded-xl px-5 pt-5 pb-0 xl:p-10 2xl:p-12.5 max-w-112.5 sm:max-w-175 xl:max-w-261.25 2xl:max-w-331.5">
                        <div className="flex justify-between items-center pb-5 xl:pb-7.5 2xl:pb-10">
                            ...
                            <Button text="Learn More" className="rounded-[28px] border-Silver! dark:border-gray-15! bg-Platinum dark:bg-gray-10"/>
                        </div>
                        <div className={`grid grid-cols-1 ${towCol ? "xl:grid-cols-2" : ""}`}>
                            {item.details.map((detail , index) => {
                                ...
                                return(
                                    <div key={index} className={`${spanFullWidth ? 'xl:col-span-2' : ''} ${changePadding ? 'pb-5 xl:pb-0 2xl:pb-0 pt-5 xl:pt-7.5 2xl:pt-10' : 'py-5 xl:py-7.5 2xl:py-10'} pe-3 border-t border-Silver dark:border-gray-15`}>
                                        <div className={` ${applyLeftBorder ? 'xl:pl-5 xl:border-l xl:border-Silver dark:border-gray-15' : ''} `}>
                                            ...
                                            <div className="flex items-center gap-3 2xl:gap-4">
                                                    ...
                                                    {detail.btn && <Button text={detail.btn} className="border-Silver! dark:border-gray-15! rounded-[28px]! px-3! py-1.5! xl:px-3! xl:py-1.5! 2xl:px-3.5! 2xl:py-2! bg-Platinum dark:bg-gray-10 text-gray-60"/>}
                                            </div>
                                        </div>
                                    </div>
                                )
