    ...
    return (
        <Section title="Navigating the Estatein Experience"
                ...
                buttonText="View All Properties">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center items-stretch auto-rows-fr gap-7.5 bg-gray-08 lg:gap-x-5 lg:gap-y-10 ">
