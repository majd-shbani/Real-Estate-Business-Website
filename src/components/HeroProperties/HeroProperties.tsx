...
interface HeroPropertiesProps {
  ...
  onFilterChange: (
    key: keyof Omit<PropertiesFilters, "search">,
    value: string,
  ) => void;
  onSubmit: () => void;
}
...
const HeroProperties = ({
  ...
  const filterItems = [
    ...
    },
    {
      ...
      options: options.sizeRanges,
    },
    {
      key: "buildYear",
      label: "Build Year",
      icon: "./assets/icons/Calender.svg",
      options: options.buildYears,
    },
  ] as const;
  ...
  return (
    <div className=" pt-41 pb-20 lg:pb-30 2xl:pb-37.5 ">
      <Section
        ...
        className="bg-[linear-gradient(95.93deg,rgba(38,38,38,0.3)_-5%,rgba(38,38,38,0)_25%)] dark:bg-[linear-gradient(95.93deg,#262626_-26.82%,rgba(38,38,38,0)_40.46%)] dark:text-white mb-0! px-4 py-12.5  lg:pr-50 lg:pl-20 lg:pt-25 lg:pb-32.5   2xl:pt-37.5 2xl:pb-40 2xl:pr-100 2xl:pl-40.5"
        showStars={false}
