  ...
  return (
    ...
    <div className="  xl:mr-25.25 px-4 py-12.5 sm:px-[40px] lg:px-17 xl:flex w-full  xl:gap-20 xl:p-20 2xl:h-113.5 2xl:px-40.5 2xl:py-25">
      <div className=" ">
       ...
       <form className="flex gap-[7.5px]  2xl:gap-2.5 border border-gray-15 rounded-lg  h-13  xl:h-13 px-[21.6px] py-[18.5px] mb-12.5 w-max  2xl:h-16.5 2xl:px-[26.5px] 2xl:py-[21.5px]">
      ...
      <div className="relative grid grid-cols-2 gap-5   border-gray-15 divide-gray-300 lg:divide-none lg:flex lg:gap-[9vw] xl:gap-[5vw] 2xl:gap-[5.8vw] ">
        ...
        {footerProps.footerProps.footerService.map((colunm ,index) => {
            ...
            return (
                ...
                <div   key={index} className={` border-b-1 border-gray-15 xl:w-max lg:border-0 flex flex-col gap-4  sm:text-center lg:text-left xl:gap-6 xl:w-[90px] 2xl:gap-6.25  2xl:font-medium ${isThird ? "row-span-2 " : ""} `}>
    ...
    <div className="flex flex-col-reverse  lg:flex-row  lg:justify-between  bg-[#1A1A1A] text-[14px] lg:px-31 xl:px-20 lg:h-17  2xl:text-[18px] text-white lg:flex w-full 2xl:h-26  2xl:px-[162px] 2xl:px-10">
