...
const RealEstateForm = () => {
      ...
      return (
            <div className="  bg-Alice-Blue text-Jet-Gray dark:bg-gray-08 rounded-3xl dark:text-white mb-20">
                  ...
                  <h2 className="text-3xl font-bold mb-10 border-b border-gray-15">
                        {isEditMode ? "Edit Detailed Listing" : "Create Full Property"}
                  </h2>

                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        {/* Basic Info & Specifications */}
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                              <section className= "bg-Silver dark:bg-gray-10 p-8 rounded-2xl dark:border border-gray-15 space-y-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                              <section className="bg-Silver dark:bg-gray-10 p-6 rounded-2xl dark:border border-gray-15 space-y-4 shadow-sm">
                                    ...
                                    <div className="flex gap-2 items-end">
                                          ...
                                          <button type="button" onClick={() => { if (tempGalleryUrl) { handleUpdate('gallery', [...formData.gallery, tempGalleryUrl]); setTempGalleryUrl(""); } }} className="bg-purple-60 p-4 rounded-lg h-fit mb-1 cursor-pointer hover:bg-purple-70 transition-colors"><FaPlus className="text-Alice-Blue" /></button>
                                    </div>
                              ...
                              <section className="bg-Silver dark:bg-gray-10 p-6 rounded-2xl dark:border border-gray-15 space-y-4 shadow-sm">
                                    ...
                                    <div className="flex gap-2 items-end">
                                          ...
                                          <button type="button" onClick={() => { if (tempAmenity) { handleUpdate('amenities', [...formData.amenities, tempAmenity]); setTempAmenity(""); } }} className="bg-purple-60 p-4 rounded-lg h-fit mb-1 cursor-pointer hover:bg-purple-70 transition-colors"><FaPlus className="text-Alice-Blue" /></button>
                                    </div>
                        ...
                        <section className="space-y-6">
                              ...
                              {pricingConfig.map((table, tIdx) => {
                                    ...
                                    return (
                                          <div key={tIdx} className='bg-Silver dark:bg-gray-10 p-8 rounded-2xl dark:border shadow-sm transition-all hover:border-purple-60/20 border-gray-15'>
                        ...
                        <button type="submit" disabled={loading} className="w-full py-6 bg-purple-60 text-white hover:bg-purple-70 rounded-2xl font-bold text-xl shadow-xl transition-all disabled:opacity-50 mt-10">
                              {loading ? "Processing Listing..." : id ? "Update All Data & Tables" : "Publish Complete Property"}
                        </button>
                  </form>
            </div>
      );
