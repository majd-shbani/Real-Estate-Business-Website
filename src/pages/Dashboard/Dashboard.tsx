...
const Dashboard = ({ links }: DashboardProps) => {
      ...
      return (
            <div className="flex h-screen overflow-hidden">
                  ...
                  <aside className={`flex flex-col items-center justify-between bg-Platinum dark:bg-gray-15 p-4 xl:p-6 2xl:p-7.5 fixed
            top-0 bottom-0 left-0 md:left-0 w-1/2 md:w-1/4 lg:w-1/6 z-40 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
                        <div className="flex flex-col items-center gap-5 xl:gap-10">
                              ...
                              <p className="text-xl xl:text-3xl 2xl:text-4xl text-Jet-Gray dark:text-white">{DEFAULT_DATA.user}</p>
                        </div>
                        <nav className="w-full">
                              <ul className="flex flex-col gap-4 xl:gap-5">
                                ...
                                ${isActive
                                                            ...
                                                            : "text-gray-60 hover:text-white hover:bg-gray-800 border border-Silver dark:border-gray-30 hover:border-gray-600"
                                                      }`
                                                }>{link.text}
                                                </NavLink>
                                          </li>
                  ...
                  <main className="flex-1 dark:bg-gray-08 bg-Alice-Blue overflow-auto ml-0 md:ml-[25%] lg:ml-[16.666667%] p-[4.16666vw] pt-28 md:pt-[4.16666vw] xl:py-7.5 2xl:py-10">
                        <Outlet />
                  </main>
            </div>
      )
